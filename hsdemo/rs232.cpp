...
int RS232::OpenComport(int comport_number, int Baud, TCHAR *portName)
{
	if((comport_number>15)||(comport_number<0))
	{
		MessageBox(0, "illegal comport number", "Error", MB_OK);
		return(1);
	}
	...
	{
		MessageBox(0, "Unable to open comport. \n Please make sure to turn on the power.", portName, MB_OK | MB_ICONERROR);
		return(1);
	}
	...
	{
		MessageBox(0, "Error getting state", portName, MB_OK | MB_ICONERROR);
	...
	{
		MessageBox(0, "Unable to set comport cfg settings", portName, MB_OK | MB_ICONERROR);
		CloseHandle(Cport[comport_number]);
		return(1);
	}
	...
	{
		MessageBox(0, "Unable to set comport time-out settings", portName, MB_OK | MB_ICONERROR);
		CloseHandle(Cport[comport_number]);
		return(1);
	}
...
void RS232::Reset(int comport_number)
{
